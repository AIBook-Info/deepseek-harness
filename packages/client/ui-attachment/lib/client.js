window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:D:\Github\AIBook-Info\deepseek-harness\packages\client\ui-attachment\src\AttachmentRail.module.css.mjs
		const css$4 = ".PAC4mq_root{min-width:0;position:relative}.PAC4mq_rail{scrollbar-width:none;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:10px;display:flex;overflow:auto hidden}.PAC4mq_rail::-webkit-scrollbar{display:none}.PAC4mq_item{flex:0 0 64px;width:64px;height:64px;position:relative}.PAC4mq_thumbnail{border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover);cursor:zoom-in;border-radius:16px;width:64px;height:64px;padding:0;overflow:hidden}.PAC4mq_thumbnail img{object-fit:cover;width:100%;height:100%;display:block}.PAC4mq_remove{z-index:1;background:var(--dsw-alias-button-contrast-fill);width:18px;height:18px;color:var(--dsw-alias-label-primary-inverted);cursor:pointer;opacity:0;border:none;border-radius:50%;place-items:center;padding:0;transition:opacity .2s ease-in-out;display:grid;position:absolute;top:4px;right:4px}.PAC4mq_item:hover .PAC4mq_remove,.PAC4mq_remove:focus-visible{opacity:1}@media (pointer:coarse){.PAC4mq_remove{opacity:1}}@media (prefers-reduced-motion:reduce){.PAC4mq_remove{transition:none}}.PAC4mq_arrow{z-index:2;border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);width:24px;height:24px;color:var(--dsw-alias-label-secondary);box-shadow:var(--dsw-shadow-lv2);cursor:pointer;border-radius:999px;place-items:center;padding:0;display:grid;position:absolute;top:50%;transform:translateY(-50%)}.PAC4mq_arrow:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}.PAC4mq_arrowLeft{left:4px}.PAC4mq_arrowRight{right:4px}";
		...
		var AttachmentRail_module_css_default = {
			"arrow": "PAC4mq_arrow",
			"arrowLeft": "PAC4mq_arrowLeft",
			"arrowRight": "PAC4mq_arrowRight",
			"item": "PAC4mq_item",
			"rail": "PAC4mq_rail",
			"remove": "PAC4mq_remove",
			"root": "PAC4mq_root",
			"thumbnail": "PAC4mq_thumbnail"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Github\AIBook-Info\deepseek-harness\packages\client\ui-attachment\src\DropOverlay.module.css.mjs
		const css$3 = ".fUpS-W_mask{z-index:1000;pointer-events:none;background-color:var(--dsw-alias-bg-mask-drop);backdrop-filter:blur(10px);justify-content:center;align-items:center;animation:.16s ease-out fUpS-W_fade-in;display:flex;position:fixed;inset:0}@keyframes fUpS-W_fade-in{0%{opacity:0}to{opacity:1}}@media (prefers-reduced-motion:reduce){.fUpS-W_mask{animation:none}}.fUpS-W_wrap{color:var(--dsw-alias-label-primary);text-align:center;flex-direction:column;align-items:center;margin-top:-3%;padding:0 40px;display:flex}.fUpS-W_illustration{width:115px;height:84px}.fUpS-W_title{font:var(--dsw-font-l-20);margin-top:16px}.fUpS-W_desc{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-tertiary);white-space:pre-wrap;margin-top:16px}";
		...
		var DropOverlay_module_css_default = {
			"desc": "fUpS-W_desc",
			"fade-in": "fUpS-W_fade-in",
			"illustration": "fUpS-W_illustration",
			"mask": "fUpS-W_mask",
			"title": "fUpS-W_title",
			"wrap": "fUpS-W_wrap"
		};
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Github\AIBook-Info\deepseek-harness\packages\client\ui-attachment\src\ImageLightbox.module.css.mjs
		const css$2 = ".i8hSNG_backdrop{z-index:1000;place-items:center;padding:40px;display:grid;position:fixed;inset:0}.i8hSNG_mask{background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}.i8hSNG_image{object-fit:contain;background:var(--dsw-specific-input-major);max-width:min(100%,1600px);max-height:calc(100vh - 80px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;position:relative}.i8hSNG_close{z-index:1;border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);width:36px;height:36px;color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:999px;place-items:center;display:grid;position:fixed;top:20px;right:20px}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Github\AIBook-Info\deepseek-harness\packages\client\ui-attachment\src\client\ComposerAttachments.module.css.mjs
		const css$1 = "._5SvfPW_rail{min-width:0;padding:4px 12px 0}";
		...
		var ComposerAttachments_module_css_default = { "rail": "_5SvfPW_rail" };
		//#endregion
		...
		//#endregion
		//#region \0dsh-css:D:\Github\AIBook-Info\deepseek-harness\packages\client\ui-attachment\src\MessageImage.module.css.mjs
		const css = ".pW3Xjq_gallery{flex-wrap:wrap;gap:10px;max-width:100%;display:flex}.pW3Xjq_gallery[data-align=end]{justify-content:flex-end;align-self:flex-end}.pW3Xjq_gallery[data-align=start]{justify-content:flex-start;align-self:flex-start}.pW3Xjq_frame{border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover);cursor:zoom-in;border-radius:16px;flex:none;place-items:center;min-width:44px;min-height:44px;padding:0;display:grid;overflow:hidden}.pW3Xjq_frame[data-variant=tile]{width:64px;min-width:64px;height:64px;min-height:64px}.pW3Xjq_frame img{object-fit:cover;width:100%;height:100%;display:block}.pW3Xjq_loading,.pW3Xjq_error{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}.pW3Xjq_error{border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover-danger);cursor:pointer;border-radius:10px;max-width:240px;padding:10px 12px}.pW3Xjq_error[data-variant=tile]{border-radius:16px;width:64px;height:64px;padding:4px;overflow:hidden}";
		...
		var MessageImage_module_css_default = {
			"error": "pW3Xjq_error",
			"frame": "pW3Xjq_frame",
			"gallery": "pW3Xjq_gallery",
			"loading": "pW3Xjq_loading"
		};
		//#endregion
