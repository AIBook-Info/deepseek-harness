window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:D:\Github\AIBook-Info\deepseek-harness\packages\client\ui-settings-plugin-inventory\src\client\PluginInventorySettingsTab.module.css.mjs
		const css = ".EgO7Pa_section{width:100%;max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:14px;display:flex}.EgO7Pa_catalogHeading h3,.EgO7Pa_status,.EgO7Pa_failure p{margin:0}.EgO7Pa_status,.EgO7Pa_failure{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:20px}.EgO7Pa_failure{color:var(--dsw-alias-state-error-primary);align-items:center;gap:10px;display:flex}.EgO7Pa_failure button{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-primary);font:inherit;cursor:pointer;background:0 0;border-radius:6px;padding:4px 10px}.EgO7Pa_catalog{flex-direction:column;gap:12px;display:flex}.EgO7Pa_search{width:100%;color:var(--dsw-alias-label-tertiary);align-items:center;display:flex;position:relative}.EgO7Pa_search>svg{pointer-events:none;position:absolute;left:12px}.EgO7Pa_search input{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:36px;color:var(--dsw-alias-label-primary);font:inherit;border-radius:8px;outline:none;padding:0 34px 0 36px;font-size:13px}.EgO7Pa_search input::placeholder{color:var(--dsw-alias-label-tertiary)}.EgO7Pa_search input:focus-visible{border-color:var(--dsw-alias-state-business-primary);box-shadow:0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}.EgO7Pa_catalogHeading{align-items:baseline;gap:7px;padding:0 2px;display:flex}.EgO7Pa_catalogHeading h3{font-size:13px;font-weight:600;line-height:20px}.EgO7Pa_catalogHeading span{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;font-size:12px;line-height:18px}.EgO7Pa_cards{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:10px;margin:0;padding:0;list-style:none;display:grid}.EgO7Pa_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:10px;min-width:0;overflow:hidden}.EgO7Pa_card[data-open=true]{border-color:var(--dsw-alias-border-l1);box-shadow:var(--dsw-shadow-lv1)}.EgO7Pa_cardContent{box-sizing:border-box;width:100%;min-height:52px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;justify-content:space-between;align-items:center;gap:12px;padding:12px 14px;display:flex}.EgO7Pa_cardContent:hover,.EgO7Pa_card[data-open=true]>.EgO7Pa_cardContent{background:var(--dsw-alias-interactive-bg-hover)}.EgO7Pa_cardContent:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.EgO7Pa_cardTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;font-weight:600;line-height:20px;overflow:hidden}.EgO7Pa_cardTrailing{color:var(--dsw-alias-label-tertiary);flex:none;align-items:center;gap:7px;display:inline-flex}.EgO7Pa_statusDot{background:var(--dsw-alias-label-tertiary);border-radius:999px;flex:none;width:7px;height:7px;display:inline-block}.EgO7Pa_statusDot[data-phase=active]{background:var(--dsw-alias-state-success-primary)}.EgO7Pa_statusDot[data-phase=failed]{background:var(--dsw-alias-state-error-primary)}.EgO7Pa_statusDot[data-phase=loading]{background:var(--dsw-alias-state-business-primary)}.EgO7Pa_configTag{background:var(--dsw-alias-bg-layer-1);min-height:20px;color:var(--dsw-alias-label-secondary);white-space:nowrap;border-radius:5px;align-items:center;padding:1px 6px;font-size:11px;line-height:16px;display:inline-flex}.EgO7Pa_configTag[data-enabled=true]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 10%, transparent);color:var(--dsw-alias-state-success-primary)}.EgO7Pa_chevron{color:var(--dsw-alias-label-tertiary);flex:none}.EgO7Pa_card[data-open=true] .EgO7Pa_chevron{transform:rotate(180deg)}.EgO7Pa_cardDetails{border-top:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);padding:10px 14px 12px}.EgO7Pa_entryValue{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font-family:var(--ds-font-family-code);font-size:12px;line-height:18px;display:block}.EgO7Pa_details{grid-template-columns:76px minmax(0,1fr);gap:6px 10px;margin:8px 0 0;display:grid}.EgO7Pa_details div{display:contents}.EgO7Pa_details dt{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:17px}.EgO7Pa_details dd{overflow-wrap:anywhere;min-width:0;color:var(--dsw-alias-label-secondary);margin:0;font-size:12px;line-height:17px}.EgO7Pa_visuallyHidden{clip:rect(0 0 0 0);clip-path:inset(50%);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:no-preference){.EgO7Pa_chevron{transition:transform .14s var(--ds-ease-in-out)}}@media (width<=680px){.EgO7Pa_cards{grid-template-columns:minmax(0,1fr)}}";
